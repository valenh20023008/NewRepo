...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MARTINPC\\SQLEXPRESS;Database=person_db;Trusted_Connection=True;TrustServerCertificate=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__estudios__3213E83FFE8E40A7");
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666D7EB99FD0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83FC83D5D04");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D656E719138");
